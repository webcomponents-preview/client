 ...
 */
export declare function isPlugin(element: HTMLElement): element is Plugin;
/**
 * Type guard for stage plugins.
 */
export declare function isStagePlugin(element: HTMLElement): element is StagePlugin;
/**
 * Type guard for preview plugins.
 * TODO: add container type guard
 */
export declare function isPreviewPlugin(element: HTMLElement): element is PreviewPlugin;
